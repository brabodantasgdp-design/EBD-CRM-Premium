...
def run():
    ...
    with sync_playwright() as pw:
        ...
        page.goto(BASE + "/dashboard", wait_until="domcontentloaded", timeout=60000); page.get_by_test_id("metric-open-pipeline").wait_for(timeout=30000)
        ...
        check("kpi_pipeline", page.get_by_test_id("metric-open-pipeline").count() == 1, page.locator("body").inner_text()[:800])
